...
(function ($) {
	$(function () {
		...
		let inputS = document.querySelector('.search-form input[name="s"]');
		if (searchForm) {
			searchForm.insertAdjacentHTML('beforeend', '<button type="reset" class="search-reset" title="Кликни, чтобы очистить поле">×</button>');
			let searchReset = document.querySelector('.search-form button[type="reset"]');
