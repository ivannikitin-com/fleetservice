	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( 0 === strcasecmp( $item->attr_title, 'divider' ) && 1 === $depth ) {
				...
				if ( $args->has_children && in_array( 'current-menu-item', $classes, true )) {
					$class_names .= ' open';
				}
				 ...
				 */
				if ( '#'!== $item->url ) {
						$item_output .= '<div class="sub-menu-close dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-hidden="true"></div>';
						$item_output .= '<a' . $icon_attributes . ' title="' . esc_attr( $item->title ) . '">';
				} else {
