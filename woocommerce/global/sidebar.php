...
if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly
			...
			<div class="aside_title"><span><?php echo _e('Каталог','fleetservice'); ?></span></div>
			...
			<?php if (is_shop() || is_tax('product_cat') || is_tax('pwb-brand') || is_tax('product_tag')) { ?>
			<div class="aside_title"><span><?php echo _e('Фильтр','fleetservice'); ?></span></div>
			<?php } ?>
